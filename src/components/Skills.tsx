  ...
  return (
    <section id="skills" className="bg-console px-6 py-24 sm:py-32 lg:pl-24 lg:pr-10">
      <div className="mx-auto w-full max-w-[1200px]">
        <Reveal>
          <span className="section-label eyebrow text-wire">LOG 02 — Stack</span>
          ...
          {skillGroups.map((group, i) => (
            <Reveal key={group.label} delay={i * 0.06}>
              <div className="editorial-card relative overflow-hidden rounded-2xl border border-paper/10 bg-gradient-to-br from-console-2/80 to-console-2/25 px-5 pb-6 pt-5 sm:px-6">
                <span aria-hidden="true" className="absolute right-5 top-5 font-mono-ui text-[0.6rem] tracking-[0.12em] text-paper/25">0{i + 1}</span>
